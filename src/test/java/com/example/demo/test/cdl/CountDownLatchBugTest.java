 ...
 * CountDownLatch学习笔记
 */
public class CountDownLatchBugTest {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < workerCount; i++) {
            service.execute(new WorkerBug(i, latch));
        }
...
class WorkerBug implements Runnable {
    private int id;
    private CountDownLatch latch ;
    public WorkerBug(int id, CountDownLatch latch) {
        this.id = id;
        this.latch = latch;
    }
    @Override
